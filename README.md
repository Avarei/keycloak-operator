...
[Getting started with keycloak-operator](https://www.keycloak.org/getting-started/getting-started-operator-kubernetes)

[Keycloak Server Installation](https://www.keycloak.org/docs/latest/server_installation/index.html#_installing-operator)
